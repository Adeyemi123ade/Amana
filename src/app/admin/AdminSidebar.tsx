...
const NAV = [
  ...
  { href: '/admin/invoices',     label: 'Billing',      icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9v13a2 2 0 01-2 2z' },
...
export default function AdminSidebar({
  ...
  return (
    <aside style={{ width: '100%', background: '#0E1A6E', minHeight: '100%', display: 'flex', flexDirection: 'column' }}>
      {/* Logo — hidden on desktop (header shows it), only visible on mobile drawer */}
      <style>{`@media (min-width: 900px) { .admin-sidebar-logo { display: none !important; } }`}</style>
      <div className="admin-sidebar-logo" style={{ padding: '16px 14px 12px', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
